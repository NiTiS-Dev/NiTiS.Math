...
/// </summary>
[DataContract]
public struct Region2d : IEquatable<Region2d>, IFormattable
{
	/// <summary>
	/// Region origin.
	/// </summary>
	...
	/// </summary>
	[IgnoreDataMember]
	public readonly Vector2d End => Origin + Size;

	/// <summary>
	/// Center of the region.
	/// </summary>
	[IgnoreDataMember]
	public readonly Vector2d Center => Origin + (Size / 2);
	...
	public Region2d(Vector2d origin, Vector2d size)
	{
		Origin = origin;
		Size = size;
	}
	...
	{
		return obj is Region2d reg && Equals(reg);
	}

	/// <inheritdoc/>
	public readonly bool Equals(Region2d other)
	{
		return this == other;
	}
	...
	public readonly bool Intersects(Region2d other)
	{
	...
	public static Region2d Intersection(in Region2d first, in Region2d second)
	{
		...
		return new Region2d(new Vector2d(x1, y1), new Vector2d(x2 - x1, y2 - y1));
	}
	...
	public static Region2d Union(in Region2d first, in Region2d second)
	{
	...
	public static bool operator ==(Region2d left, Region2d right)
	{
